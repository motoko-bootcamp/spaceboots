...
import { idlFactory } from './spaceboots_board.did.js';
export { idlFactory } from './spaceboots_board.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SPACEBOOTS_BOARD;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./spaceboots_board.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the spaceboots_board canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./spaceboots_board.did.js")._SERVICE>}
 */
export const spaceboots_board = createActor(canisterId);
