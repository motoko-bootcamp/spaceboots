...
import { idlFactory } from './spaceboots_boots.did.js';
export { idlFactory } from './spaceboots_boots.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SPACEBOOTS_BOOTS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./spaceboots_boots.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the spaceboots_boots canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./spaceboots_boots.did.js")._SERVICE>}
 */
export const spaceboots_boots = createActor(canisterId);
